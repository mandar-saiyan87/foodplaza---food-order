  ...
  return (
    <>
      <div className="nav_main">
        ...
        <div className="nav-end">
          ...
          <NavLink to="/cart">
            <div className="cart_status">
              {isDbUser && cart.length > 0 ? (
                <div className="cart_added"></div>
              ) : null}
        ...
        {mobileDrawer && (
          <div
            className={`overlay ${mobileDrawer && "overlay-show"}`}
            onClick={() => setMobileDrawer(false)}
          >
            <div
              className={`mobile_menu-drawer ${mobileDrawer && "drawer_open"}`}
            >
